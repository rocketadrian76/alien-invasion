...
class AlienInvasion:
    """Overall class to manage game sassets and behavior."""
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # Remove any bullers and aliens that have collided.
        ...
        if not self.alien:
                # Destroy sxisting bullets and create new fleet.
                self.bullets.empty()
                self._create_fleet()
    ...
    def _check_play_button(self, mouse_pos):
        ...
        if button_clicked and not self.stats.game_active:
            ...
            # Get rid of any remaining aliens and bulers.
            self.alien.empty()
            self.bullets.empty()
